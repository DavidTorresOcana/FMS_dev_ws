...
namespace KinectMLConnect
{
    public class MATWriter
    {
        #region Members
        // File access
        private System.IO.FileStream mlFile = null;

        // Main header field consisting of text
        private byte[] headerTextField = null;

        // Header text default string
        private string headerTextFieldDefault = null;

        // Data description field or "Tag Field"
        private byte[] tagField = null;

        // Data of arrayfield
        private byte[] arrayField = null;

        // Data description field or "Tag Field"
        private byte[] arrayTagField = null;

        // Data of dimensions field
        private byte[] dimField = null;

        // Data description field or "Tag Field"
        private byte[] dimTagField = null;

        // Data of name field
        private byte[] nameField = null;

        // Data description field or "Tag Field"
        private byte[] nameTagField = null;

        // Data of datatype field
        private byte[] dataType = null;

        // Data of datapadding
        private byte[] dataPadding = null;
        #endregion
